  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="bg-green-600 hover:bg-green-700 transition px-6 py-3 rounded text-white font-medium"
        >
          Gönder
        </button>
      </motion.form>
      ...
      >
        ...
        />
        <ContactItem
          icon={<FaLinkedin className="text-green-400 text-xl" />}
          text="LinkedIn"
          href="https://www.linkedin.com/in/ebrar-kadir-%C3%A7etin-1a728019b/"
        />
        <ContactItem
          icon={<FaGithub className="text-green-400 text-xl" />}
          text="GitHub"
        ...
        />
        <ContactItem
          icon={<FaTelegramPlane className="text-green-400 text-xl" />}
          text="Telegram"
